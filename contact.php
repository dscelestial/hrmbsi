...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
        ...
        <p hidden>Status <span>*</span></p>
         ...
         <textarea name="msg" class="box" placeholder="Enter your message" required cols="30" rows="10" maxlength="5000"></textarea>
        <p hidden>Status <span>*</span></p>
            <select name="status" class="box" hidden required>
               <!--<option value="" disabled selected>-- select user status</option>
               <option value="Active">Active</option>-->
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="https://hrmbsi.com.ph/" style="text-decoration: none;">hrmbsi.recruitment@gmail.com</a>
         <a href="https://hrmbsi.com.ph/" style="text-decoration: none;">inquiries@hrmbsi.com.ph</a>
      </div>

      <div class="box">
         <i class="fas fa-map-marker-alt"></i>
         <h3>Office Address</h3>
         <a href="https://hrmbsi.com.ph/" style="text-decoration: none;">Unit 1416 AIC-Burgundy Empire Tower, Ortigas Center, Pasig City</a>
      </div>
