...
if(isset($_POST['submit'])){
   ...
   $msg = "Registration complete. Kindly wait for the admin to activate your account. For the payment,  You can pay through this accounts GCASH: 09279941026 BPO: 8372-92381-2304
   Here is the list of your provided details - Organization: $organization, Email: $email, Attendees: $attendees
...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      <h3>Registration</h3>
     <center><span style="font-size: 15px;"><b>NOTE:</b> If you already have an account, go down to the bottom part and click the link below to register with your inactive acccount. Thank you for your cooperation!</span></center>
      <div class="flex">
         <div class="col">
      ...
      <p class="link">Go back? <a href="register.php">Here</a></p>
