...
if(isset($_POST['submit'])){
   ...
   $imgpath = ("../uploaded_files/ecert/" . $file . "-" . $date . "-" . $time . ".png");
         ...
         $msg = "Good Day $name, Your certificate has been sent to your email - $email.
...
<head>
   ...
   <title>HRMBSi | Certification</title>
...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" name="submit" value="Create User Certificate" class="btn">
      </div>
   </form>
