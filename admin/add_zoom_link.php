...
if(isset($_POST['submit'])){
   ...
   $select_zoom = $conn->prepare("SELECT * FROM `zoom` WHERE link = ?");
   $select_zoom->execute([$link]);
...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      <h3>Attach Zoom Link</h3>
      <div class="flex">
         <div class="col">
         <p>Event Title <span>*</span></p>
            <input type="text" name="title" placeholder="Enter event title" required class="box">
         <p>Event Link <span>*</span></p>
            <input type="text" name="link" placeholder="Enter event link" required class="box">
      ...
      <input type="submit" name="submit" value="Add Link" class="btn">
   </form>
