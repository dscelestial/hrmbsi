...
if(isset($_POST['submit'])){
   ...
   Here is the list of your provided details - Name: $name, Organization:, Email: $email";
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_tutor = $conn->prepare("INSERT INTO `tutors`(id, name, profession, email, password, image, status) VALUES(?,?,?,?,?,?,?)");
         $insert_tutor->execute([$id, $name, $profession, $email, $cpass, $rename, $status]);
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="Confirm your password" minlength="8" maxlength="12" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required class="box">
      ...
      <p class="link">Go back? <a href="http://localhost/hrmbsi/home.php">Here</a></p>
