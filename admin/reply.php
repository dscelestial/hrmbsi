   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <!--<p>Email <span>*</span></p>-->
            <input type="text" name="email" value="<?= $fetch_tuts['email']; ?>" required class="box" readonly hidden>
      ...
      <input type="submit" name="submit" value="Add Message" class="btn">
      </div>
   </form>
